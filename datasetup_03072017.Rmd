...
sum(table(or.df$PEP.Unique.ID)>1)
```
...
# Among thos who Restart Claims, is date after intiial claim
...
#all.equal(or.df[existingids,],or.wages2016Q3[existingids,])


or.df[existingids,]<-or.wages2016Q3[existingids,]
# Add new cases
...
end.date <- strptime(c("31.12.2016"), format = "%d.%m.%Y")
...
```{r}
save(or.df1,or.df2,or.df3,or.df4,or.df5,or.df6,or.df7,or.df8,or.df9,or.df10,
     file="Data/clean/monthlyordat.rda")
