...
pairweights<-wrkdat %>% group_by(pair) %>% dplyr::summarise(
    pairN=sum(N),
    treat_weight=sum(N[treat==1])/sum(N),
    ctrl_weight=sum(N[treat==0])/sum(N)
    
)
n<-sum(wrkdat$N)
wrkdat<-inner_join(wrkdat,pairweights,by="pair")
wrkdat$weight[wrkdat$treat==1]<-with(wrkdat[wrkdat$treat==1,],pairN/n*treat_weight)
wrkdat$weight[wrkdat$treat==0]<-with(wrkdat[wrkdat$treat==0,],pairN/n*ctrl_weight)
...
wrkdat_emp$weight[wrkdat_emp$treat==1]<-with(wrkdat_emp[wrkdat_emp$treat==1,],pairN/n*treat_weight)
wrkdat_emp$weight[wrkdat_emp$treat==0]<-with(wrkdat_emp[wrkdat_emp$treat==0,],pairN/n*ctrl_weight)
...
wrkdat_emp2$weight[wrkdat_emp2$treat==1]<-with(wrkdat_emp2[wrkdat_emp2$treat==1,],pairN/n*treat_weight)
wrkdat_emp2$weight[wrkdat_emp2$treat==0]<-with(wrkdat_emp2[wrkdat_emp2$treat==0,],pairN/n*ctrl_weight)
...
wrkdat_noneg$weight[wrkdat_noneg$treat==1]<-with(wrkdat_noneg[wrkdat_noneg$treat==1,],pairN/n*treat_weight)
wrkdat_noneg$weight[wrkdat_noneg$treat==0]<-with(wrkdat_noneg[wrkdat_noneg$treat==0,],pairN/n*ctrl_weight)   
...
wrkdat2$weight[wrkdat2$treat==1]<-with(wrkdat2[wrkdat2$treat==1,],pairN/n*treat_weight)
wrkdat2$weight[wrkdat2$treat==0]<-with(wrkdat2[wrkdat2$treat==0,],pairN/n*ctrl_weight)
...
wrkdat_month$weight[wrkdat_month$treat==1]<-with(wrkdat_month[wrkdat_month$treat==1,],pairN/n*treat_weight)
wrkdat_month$weight[wrkdat_month$treat==0]<-with(wrkdat_month[wrkdat_month$treat==0,],pairN/n*ctrl_weight)
