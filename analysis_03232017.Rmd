...
pairweights$weight<-pairweights$pairN/sum(pairweights$pairN)/2    
...
pairweights_emp$weight<-pairweights_emp$pairN/sum(pairweights_emp$pairN)/2    
...
pairweights_emp2$weight<-pairweights_emp2$pairN/sum(pairweights_emp2$pairN)/2    
...
pairweights_noneg$weight<-pairweights_noneg$pairN/sum(pairweights_noneg$pairN)/2    
...
pairweights2$weight<-pairweights2$pairN/sum(pairweights2$pairN)/2    
...
pairweights_month$weight<-pairweights_month$pairN/sum(pairweights_month$pairN)/2    
