...
offices <- unique(or.df.TOTAL$fonum)
...
for(i in 1:14)
{
	desc.table.1[i, 1] <- length(which(or.df1$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for April
for(i in 1:14)
{
	desc.table.1[i, 2] <- length(which(or.df2$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for May
for(i in 1:14)
{
	desc.table.1[i, 3] <- length(which(or.df3$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for June
for(i in 1:14)
{
	desc.table.1[i, 4] <- length(which(or.df4$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for July
for(i in 1:14)
{
	desc.table.1[i, 5] <- length(which(or.df5$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for August
for(i in 1:14)
{
	desc.table.1[i, 6] <- length(which(or.df6$X277.Field.Office==offices[i]))
}

#Add the counts of welcomes for September
for(i in 1:14)
{
	desc.table.1[i, 7] <- length(which(or.df7$X277.Field.Office==offices[i]))
}

## Order table

desc.table.1 <- desc.table.1[order(row.names(desc.table.1)),]
...
tmp <- tmp[,c("March","April","May","June","July","August","September","November")]
stopifnot(all.equal(tmp[,1:7],desc.table.1,check.attributes=FALSE))
```
