...
These are the first set of people who entered the program: people who entered the 18th week of 2016 or prior. Because some of the people, who entered late, didn't have time to show actual outcomes. Assess balance here.
...
## Outcomes
 ...
 - `uiexit` -- stop making claims fro 3 weeks in a row before exhausting

 - employment (employed.pair.delta )

 - wages

 - amount of time to exit (time.to.exit) --- survival analysis

## Employment Center Level analysis

Aggregate the data by field office and see if there is a difference as a simple linear model.
